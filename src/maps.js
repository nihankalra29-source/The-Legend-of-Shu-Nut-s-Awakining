...
const MAPS = {
  village: {
    ...
    transitions: [
      ...
      { x: 9, y: 11, toMap: 'hollow', toX: 10, toY: 2, requires: 'acorn_key', lockedDialogue: 'chasm_locked' },
      { x: 10, y: 11, toMap: 'hollow', toX: 10, toY: 2, requires: 'acorn_key', lockedDialogue: 'chasm_locked' },
  ...
  hollow: {
    ...
    transitions: [
      ...
      { x: 9, y: 12, toMap: 'ruins', toX: 10, toY: 11, requires: 'husk_lantern', lockedDialogue: 'ruins_locked' },
      { x: 10, y: 12, toMap: 'ruins', toX: 10, toY: 11, requires: 'husk_lantern', lockedDialogue: 'ruins_locked' },
    ],
    encounters: [],
