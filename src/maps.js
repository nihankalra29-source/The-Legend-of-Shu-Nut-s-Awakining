...
const MAPS = {
  ...
  hollow: {
    ...
    transitions: [
      ...
      { x: 9, y: 12, toMap: 'ruins', toX: 10, toY: 8, requires: 'husk_lantern', lockedDialogue: 'ruins_locked' },
      { x: 10, y: 12, toMap: 'ruins', toX: 10, toY: 8, requires: 'husk_lantern', lockedDialogue: 'ruins_locked' },
    ],
    encounters: [],
